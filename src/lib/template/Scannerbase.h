...
#ifndef db_aggScannerBASE_H_INCLUDED
#define db_aggScannerBASE_H_INCLUDED
...
protected:
    ...
    int     const (*d_dfaBase__)[33];

    static int     const s_dfa__[][33];
    static int     const (*s_dfaBase__[])[33];
