...
#ifndef db_aggParserBase_h_included
#define db_aggParserBase_h_included
...
// $insert polymorphicSpecializations
    ...
    template <>
    struct TagOf<ASTNode*>
    {
        static Tag__ const tag = Tag__::NODE;
    };

    template <>
    struct TypeOfBase<Tag__::TEXT>
    {
        typedef std::string DataType;
    };

    template <>
    struct TypeOfBase<Tag__::NODE>
    {
        typedef ASTNode* DataType;
    };
